"""Configuration for LightGBM Quantile Regression forecast."""
...
FUNDAMENTAL_COLS = [
    ...
    "tgt_load_daily_avg",
    "tgt_load_daily_peak",
    "tgt_load_daily_valley",
    "tgt_load_west_daily_avg",
    "tgt_load_west_daily_peak",
    "tgt_load_morning_ramp",
    "tgt_load_evening_ramp",
    # Gas
    "gas_m3_daily_avg",
    "gas_m3_onpeak_avg",
    "gas_m3_offpeak_avg",
    ...
    "tgt_outage_total_mw",
    "tgt_outage_forced_mw",
    "outage_total_mw",
    "outage_forced_mw",
    # Renewables (target-date forecasts)
    "tgt_solar_daily_avg",
    "tgt_wind_daily_avg",
    "tgt_renewable_daily_avg",
    # Nuclear
    "nuclear_daily_avg",
    # Calendar
    "dow_sin",
...
DAY_TYPE_LGBM_PROFILES: dict[str, dict[str, Any]] = {
    DAY_TYPE_WEEKDAY: {},
    DAY_TYPE_SATURDAY: {
...
class LGBMQRConfig:
    ...
    def resolved_day_type_profiles(self) -> dict[str, dict[str, Any]]:
        base = copy.deepcopy(DAY_TYPE_LGBM_PROFILES)
    ...
    def with_day_type_overrides(self, target_date) -> tuple["LGBMQRConfig", str]:

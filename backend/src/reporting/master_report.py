...
REPORT_GROUPS: dict[str, tuple[str, str]] = {
    ...
    "like_day_forecast_ice_level": ("DA Model", "ICE Level Adjusted"),
    ...
    "load_forecast_vintage_combined": ("Forecasts", "Load Forecast Vintages"),
    "pjm_rto_forecast_snapshot": ("Forecasts", "PJM RTO Snapshot"),
    "pjm_west_forecast_snapshot": ("Forecasts", "PJM Western Snapshot"),
    "pjm_midatl_forecast_snapshot": ("Forecasts", "PJM Mid-Atlantic Snapshot"),
    "pjm_south_forecast_snapshot": ("Forecasts", "PJM Southern Snapshot"),
    "meteologica_rto_forecast_snapshot": ("Forecasts", "Meteologica RTO Snapshot"),
    "meteologica_west_forecast_snapshot": ("Forecasts", "Meteologica Western Snapshot"),
    "meteologica_midatl_forecast_snapshot": ("Forecasts", "Meteologica Mid-Atlantic Snapshot"),
    "meteologica_south_forecast_snapshot": ("Forecasts", "Meteologica Southern Snapshot"),
    "net_load_forecast_vintage_combined": ("Forecasts", "Net Load Forecast Vintages"),
    "solar_forecast_vintage_combined": ("Forecasts", "Solar Forecast Vintages"),
    "wind_forecast_vintage_combined": ("Forecasts", "Wind Forecast Vintages"),
    "regional_spark_spreads": ("Fuel Mix", "Regional Spark Spreads"),
    ...
    "tie_flows": ("Tie Flows", "Tie Flows"),
    "data_inspection": ("Data Inspection", "Data Inspection"),

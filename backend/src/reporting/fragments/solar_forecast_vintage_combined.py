...
For RTO: PJM Solar, Meteologica Solar.
...
from src.reporting.fragments.like_day_forecast_chart_utils import (
    ...
    vintage_order, empty,
    build_vintage_badges, build_vintage_chart,
...
def build_fragments(
    ...
    if df_pjm is not None and len(df_pjm) > 0:
        ...
        fragments.append(("PJM RTO", chart, None))
    else:
        fragments.append(("PJM RTO",
    ...
    if df_meteo_rto is not None and len(df_meteo_rto) > 0:
        ...
        fragments.append(("Meteologica RTO", chart, None))
    else:
        fragments.append(("Meteologica RTO",
